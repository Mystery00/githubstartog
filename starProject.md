...
- **Description:** 20 MB lightweight cross-platform database client for 90+ databases, including MySQL, PostgreSQL, SQLite, Redis, MongoDB, DuckDB, SQL Server, and Dameng. Built-in AI, MCP Server, CLI, desktop and Docker. | 轻量级跨平台数据库管理工具，支持 MySQL、PostgreSQL、SQLite、Redis、MongoDB、达梦等 90+ 数据库，提供桌面端、Docker、CLI、内置 AI 助手和 MCP Server。
...
- **Description:** A lightweight, open-source, fully local alternative to Logitech Options+ for remapping Logitech HID++ mice.
...
- **Description:** a clean, practical, ad-free IPTV app
...
### [houbb/rate-limit](https://github.com/houbb/rate-limit)
...
- **Description:** MusicPlayer2是一款功能强大的本地音乐播放软件，旨在为用户提供最佳的本地音乐播放体验。它支持歌词显示、歌词卡拉OK样式显示、歌词在线下载、歌词编辑、歌曲标签识别、专辑封面显示、专辑封面在线下载、频谱分析、音效设置、任务栏缩略图按钮、主题颜色、格式转换等功能，支持高度自定义的界面布局，支持多种播放内核（BASS和FFMpeg）。播放器支持大部分常见的音频格式。
...
- **Description:** Ip2region is an offline IP-to-Region localization library and IP data management framework with both IPv4 and IPv6 supports, 10-microsecond level query efficiency, xdb search client for many programming languages
...
### [dromara/hmily](https://github.com/dromara/hmily)
...
- **Description:** Gradle plugin for creating fat/uber JARs, transforming files, relocating packages, and optimizing with R8/ProGuard. The Gradle counterpart to Maven Shade Plugin.
...
### [tossp/lede-k3](https://github.com/tossp/lede-k3)
...
### [kwk/docker-registry-frontend](https://github.com/kwk/docker-registry-frontend)
...
### [Aefyr/SAI](https://github.com/Aefyr/SAI)
...
### [telegram-sms/telegram-sms](https://github.com/telegram-sms/telegram-sms)
...
### [Magisk-Modules-Repo/mm](https://github.com/Magisk-Modules-Repo/mm)
- **Description:** mm
...
### [mcxiaoke/apptoolkit](https://github.com/mcxiaoke/apptoolkit)
...
- **Description:** 仿酷安客户端的主题切换动画效果

### [kymjs/EmojiChat](https://github.com/kymjs/EmojiChat)
- **Description:** Android聊天界面+emoji表情+大表情实现
...
### [OYMiss/forward-bot](https://github.com/OYMiss/forward-bot)
...
- **Description:** Easily add slide to dismiss functionality to an Activity 

### [HuanTanSheng/EasyPhotos](https://github.com/HuanTanSheng/EasyPhotos)
- **Description:** 兼容android11、android 10，相机拍照，相册选择(单选/多选)，文件夹图片选择(单选/多选)，视频选择，视频图片多类型复杂选择，各界面根据状态栏颜色智能适配状态栏字体颜色变色为深色或浅色，根据使用场景智能适配沉浸式状态栏，内部处理运行时权限，支持Glide/Picasso/Imageloader等所有图片加载框架库的带默认勾选选中图片的能填充自定义广告的自定义Ui相机相册图片浏览选择器；更有拼图/文字贴纸/贴图/图片缩放/Bitmap图片添加水印/媒体文件更新到媒体库等众多Bitmap图片编辑功能的android Bitmap图片处理工具框架库。
...
### [zfman/AlgorithmCode](https://github.com/zfman/AlgorithmCode)
- **Description:** 本仓库整理了LeetCode和剑指offer上的算法题目以及参考代码

### [fython/EnhancedScreenshotNotification](https://github.com/fython/EnhancedScreenshotNotification)
- **Description:** Enhanced Screenshot Notification (Nevolution Decorator)
...
- **Description:** :point_right: Customize the LayoutManager of RecyclerView(自定义LayoutManager)
...
- **Description:** 一款开源、完善、高效的Android课程表控件，支持添加广告、课程重叠自动处理、透明背景设置、空白格子点击事件处理等丰富的功能，并且有完善的开发文档、案例以供参考
...
### [shiweibsw/Android-kotlin-extend-utils](https://github.com/shiweibsw/Android-kotlin-extend-utils)
- **Description:** Kotlin 常用扩展函数总结
...
### [android-in-china/Compatibility](https://github.com/android-in-china/Compatibility)
- **Description:** 用于反馈和跟踪国内 Android 设备/ROM 兼容性问题的公益项目

### [yale8848/CacheWebView](https://github.com/yale8848/CacheWebView)
- **Description:** Custom implement Android WebView cache, offline website, let cahe config more simple and  flexible 
...
- **Description:** 🚚 Espresso is an express delivery tracking app designed with Material Design style, built on MVP(Model-View-Presenter) architecture with RxJava2, Retrofit2, Realm database and ZXing
...
- **Description:** 来电信息 - 一个获取号码归属地和其他信息（诈骗、骚扰等）的开源 Android 应用
...
- **Description:** An android lib for enhancing BottomNavigationView. 一个增强BottomNavigationView的安卓库。
...
### [florent37/FiftyShadesOf](https://github.com/florent37/FiftyShadesOf)
- **Description:** An elegant context-care loading placeholder for Android

### [peterychuang/Flat-Plat-Blue](https://github.com/peterychuang/Flat-Plat-Blue)
...
### [daniruiz/flat-remix-gnome](https://github.com/daniruiz/flat-remix-gnome)
...
### [daniruiz/flat-remix](https://github.com/daniruiz/flat-remix)
...
### [thundernet8/AlipayOrdersSupervisor](https://github.com/thundernet8/AlipayOrdersSupervisor)
- **Description:** :sparkles: 使用Node监视支付宝订单，即时通知服务器以实现免签约支付接口
...
### [ibaozi-cn/flutter-jetpack](https://github.com/ibaozi-cn/flutter-jetpack)
- **Description:** Flutter jetpack project help you find better dependency library. Welcome to my website (http://jetpack.net.cn)

### [Kotlin/dokka](https://github.com/Kotlin/dokka)
- **Description:** API documentation engine for Kotlin

### [dcendents/android-maven-gradle-plugin](https://github.com/dcendents/android-maven-gradle-plugin)
- **Description:** Abandoned. This is now supported by the android build plugin: https://developer.android.com/studio/build/maven-publish-plugin
...
### [suphon-t/AndroidP-ify](https://github.com/suphon-t/AndroidP-ify)
- **Description:** [Xposed] Use features introduced in Android P on your O+ Device!
...
- **Description:** Name UI states, navigate between them, remember where you've been.
...
- **Description:** 在线制作`sorry 为所欲为`的gif

### [digimezzo/dopamine-windows](https://github.com/digimezzo/dopamine-windows)
- **Description:** Audio player which tries to make organizing and listening to music as simple and pretty as possible.

### [adrienbrignon/cloudflare-ddns](https://github.com/adrienbrignon/cloudflare-ddns)
- **Description:** A script to update your Cloudflare DNS records at a glance.

### [ximsfei/Android-skin-support](https://github.com/ximsfei/Android-skin-support)
- **Description:** Android-skin-support is an easy dynamic skin framework to use  for Android, Only one line of code to integrate it. Android 换肤框架, 极低的学习成本, 极好的用户体验. "一行"代码就可以实现换肤, 你值得拥有!!!
...
### [JogleLew/coolq-telegram-bot-x](https://github.com/JogleLew/coolq-telegram-bot-x)
...
### [AICP/packages_apps_Settings](https://github.com/AICP/packages_apps_Settings)

### [AICP/frameworks_base](https://github.com/AICP/frameworks_base)

### [xiaoyunfei/LineChart](https://github.com/xiaoyunfei/LineChart)
- **Description:** 这是一个实用的折线图，使用简单、灵活

### [lb377463323/GraphicsTestBed](https://github.com/lb377463323/GraphicsTestBed)
- **Description:** Learn Android Graphics.

### [AbrahamCaiJin/CommonUtilLibrary](https://github.com/AbrahamCaiJin/CommonUtilLibrary)
- **Description:** 快速开发工具类收集，史上最全的开发工具类，欢迎Follow、Fork、Star
...
### [dosgo/ngrok-c](https://github.com/dosgo/ngrok-c)
- **Description:** ngrok client for c language,Due to the use of GO ngrok language development, porting to embedded devices some inconvenience, such as openwrt, so use C language rewrite a client. Very mini, the need to support polarssl library.
...
- **Description:** A spinner view for Android

### [iielse/switchbutton](https://github.com/iielse/switchbutton)
- **Description:** iOS风格SwitchButton。 只涉及到一个类文件，异常容易集成进入你的项目。支持开关的"延时和回滚"操作。only one class file, very easy to integrate into your program. support the delay operation and rolling back action of the switch

### [MiPushFramework/MiPushFramework](https://github.com/MiPushFramework/MiPushFramework)
- **Description:** [Archived, FORK: https://github.com/NihilityT/MiPushFramework] Let supported push service run system-ly on every Android devices
...
### [AICP/kernel_moto_shamu](https://github.com/AICP/kernel_moto_shamu)

### [LineageOS/android_packages_apps_Recorder](https://github.com/LineageOS/android_packages_apps_Recorder)

### [amirzaidi/Launcher3](https://github.com/amirzaidi/Launcher3)
- **Description:** The Launcher3 fork known as "Rootless Pixel Launcher"

### [WhoIsAA/SocketDemo](https://github.com/WhoIsAA/SocketDemo)
- **Description:** 创建热点发送文件，让另一台手机连接热点接收文件
...
### [JanYoStudio/JanYoShare2.0](https://github.com/JanYoStudio/JanYoShare2.0)
- **Description:** Better sharing apks in Android

### [JanYoStudio/enspire-server](https://github.com/JanYoStudio/enspire-server)
- **Description:** Smart Home Server

### [lensh/koa2-cet](https://github.com/lensh/koa2-cet)
- **Description:** English-querying system for Grade 4 and Grade 6 with free api interface,based on angular and koa2 

### [Clans/FloatingActionButton](https://github.com/Clans/FloatingActionButton)
- **Description:** Android Floating Action Button based on Material Design specification
...
- **Description:** a custom pull-to-refresh layout which contains a interesting animation

### [ybq/ParallaxViewPager](https://github.com/ybq/ParallaxViewPager)
- **Description:** Android Parallax-ViewPager

### [Trinea/android-open-project](https://github.com/Trinea/android-open-project)
- **Description:** A categorized collection of Android Open Source Projects,  More powerful web version:

### [JetradarMobile/android-snowfall](https://github.com/JetradarMobile/android-snowfall)
...
- **Description:** A lightweight, good expandability Android library used for displaying different pages like loading, error, empty, timeout or even your custom page when you load a page.(优雅地处理加载中，重试，无数据等)

### [Yalantis/uCrop](https://github.com/Yalantis/uCrop)
- **Description:** Image Cropping Library for Android

### [hymanAndroid/tools](https://github.com/hymanAndroid/tools)
...
- **Description:** [Android] 这是一个自定义Loading View库。暂停更新

### [googlesamples/assistant-sdk-python](https://github.com/googlesamples/assistant-sdk-python)
...
- **Description:** 类似QQ空间，新浪微博个人主页下拉头部放大的布局效果，支持ListView，GridView，ScrollView，WebView，RecyclerView，以及其他的任意View和ViewGroup。支持头部视差动画，阻尼下拉放大，滑动过程监听。
...
### [xaverkapeller/SortedListAdapter](https://github.com/xaverkapeller/SortedListAdapter)
- **Description:** The RecyclerView.Adapter that makes your life easy!

### [baiiu/TSnackbar](https://github.com/baiiu/TSnackbar)
- **Description:** 从上向下滑出的Snackbar

### [bumptech/glide](https://github.com/bumptech/glide)
- **Description:** An image loading and caching library for Android focused on smooth scrolling

### [ResurrectionRemix/platform_manifest](https://github.com/ResurrectionRemix/platform_manifest)
- **Description:** Resurrection Remix Android Manifest

### [jitpack/jitpack.io](https://github.com/jitpack/jitpack.io)
...
### [Noisyfox/NoExclamation](https://github.com/Noisyfox/NoExclamation)
- **Description:** 叹号杀手-去除安卓手机在国内时网络图标上的感叹号

### [ysc3839/FontMod](https://github.com/ysc3839/FontMod)
- **Description:** Simple hook tool to change Win32 program font.

### [wangchenyan/lrcview](https://github.com/wangchenyan/lrcview)
- **Description:** Android beautiful draggable lyric view library

### [kuyagic/telegram_smartqq_bot](https://github.com/kuyagic/telegram_smartqq_bot)
- **Description:** a bot for smartqq in telegram

### [liuyuhong0324/JYShare](https://github.com/liuyuhong0324/JYShare)
...
### [ResurrectionRemix/android_frameworks_base](https://github.com/ResurrectionRemix/android_frameworks_base)
- **Description:** Resurrection Remix Frameworks
...
- **Description:** An Android library that makes developers use SQLite database extremely easy.

### [nillith/AutoVersion](https://github.com/nillith/AutoVersion)
- **Description:** Generate versionCode and versionName for android app based on git commit count automatically

### [adapta-project/adapta-gtk-theme](https://github.com/adapta-project/adapta-gtk-theme)
- **Description:** An adaptive Gtk+ theme based on Material Design Guidelines

### [iblh/hexo-theme-material](https://github.com/iblh/hexo-theme-material)
...
### [LineageOS/android_kernel_moto_shamu](https://github.com/LineageOS/android_kernel_moto_shamu)

### [LineageOS/android_device_moto_shamu](https://github.com/LineageOS/android_device_moto_shamu)

### [andreisergiu98/arc-flatabulous-theme](https://github.com/andreisergiu98/arc-flatabulous-theme)
...
### [cyngn/android_packages_themes_Template](https://github.com/cyngn/android_packages_themes_Template)

### [google/material-design-icons](https://github.com/google/material-design-icons)
- **Description:** Material Design icons by Google (Material Symbols)

### [MobDevGroup/DevelopmentTools](https://github.com/MobDevGroup/DevelopmentTools)
- **Description:** Collect and classify development tools
...
- **Description:** A bueautiful RefreshLayout
